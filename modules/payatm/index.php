	...
	<form  name="NLpayBank" action="#" method="post">	
		<table style="clear:both;width:500px;padding-left:46px;"> 
			...
			<tr><td>Số tiền thanh toán: </td>
				<?php
				echo '<b style="color:red;">Lấy thông tin khách hàng, giá giỏ hàng truyền vào số tiền, thông tin khách hàng là xong</b>';	
				?>
				<td>
					
					 <input type="text" style="width:270px" id="total_amount" name="total_amount" class="field-check " value="1115" disabled="">
				</td>
			</tr>
			<tr><td>Họ Tên: </td>
				<td>
